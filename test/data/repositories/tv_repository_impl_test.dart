...
void main() {
  ...
  group('Get Episode From Tv Series Season', () {
    final tId = 1;
    ...
    test('should return tv list when call to data source is successful',
        () async {
      // arrange
      when(mockRemoteDataSource.getEpisodeFromTvSeriesSeason(
        tId,
        tSeasonNumber,
      )).thenAnswer((_) async => testListEpisode);
      // act
      final result =
          await repository.getEpisodeFromTvSeriesSeason(tId, tSeasonNumber);
      // assert
      /* workaround to test List in Right. Issue: https://github.com/spebbe/dartz/issues/80 */
      final resultList = result.getOrElse(() => []);
    ...
    test('should return ServerFailure when call to data source is unsuccessful',
      ...
      // act
      final result = await repository.getEpisodeFromTvSeriesSeason(
        tId,
        tSeasonNumber,
      );
      // assert
  ...
  group('save tv to watchlist', () {
    test('should return success message when saving successful', () async {
      ...
      when(mockLocalDataSource
              .insertTvToWatchlist(TvTable.fromEntity(testTvSeriesDetail)))
  ...
  group('remove tv from watchlist', () {
    test('should return success message when remove successful', () async {
      // arrange
      when(mockLocalDataSource
              .removeTvFromWatchlist(TvTable.fromEntity(testTvSeriesDetail)))
